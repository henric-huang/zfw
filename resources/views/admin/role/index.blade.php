...
@section('cnt')
    ...
    <div class="page-container">
        <form method="get" action="{{ route('admin.role.index') }}" class="text-c"> 输入想要搜索的角色名称：
            <input type="text" class="input-text" style="width:250px" placeholder="角色" value="{{ $name }}" name="name"
                   autocomplete="off">
        ...
        <span class="l">
            ...
            <a href="/admin/role/create" class="btn btn-primary radius">
                ...
                @foreach($data as $item)
                    <tr class="text-c">
                        ...
                        <td class="td-manage">
                            ...
                            {!! $item->deleteBtn('admin.role.destroy') !!}
                        </td>
                    </tr>
                @endforeach
                </tbody>
